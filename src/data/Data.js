const data = {
    ...
    about: {
        ...
        details: [
            ...
            `Jiang is the author of [*Contexts and Dialogue: Yogācāra Buddhism and Modern Psychology on the Subliminal Mind*](/buddhism_and_psychology) and the co-editor of [*The Reception and Rendition of Freud in China: China’s Freudian Slip*](/freud_in_china). His [articles](/papers) have appeared in leading Asian and comparative philosophy journals and several major anthologies. Currently Jiang is working on several book projects simultaneously. A monograph on classical Chinese philosophy is the closest to completion. Others include a new interpretation of Linji's Chan Buddhist philosophy, Buddha Nature in medieval Chinese intellectual history and a comparative project on free will. He has also written about religions in contemporary China. `,
            `Jiang is director of the multidisciplinary [Rutgers Center for Chinese Studies](https://rccs.rutgers.edu). He also co-directs the [Rutgers Workshop on Chinese Philosophy](/events) and co-chairs the [Neo-Confucian Studies Seminar](http://universityseminars.columbia.edu/seminars/neo-confucian-studies/) at Columbia University. He is currently the co-chair of the [Buddhist Philosophy Unit](https://papers.aarweb.org/pu/buddhist-philosophy-unit) under the American Academy of Religion annual meeting.`,
