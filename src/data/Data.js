const data = {
        ...
        pub_2: [
            {
                ...
                introduction: 'On July 21, 2019, Tao Jiang was interviewed in Mt. Jiuhua by iFeng News 鳳凰網, a popular Chinease language news channel headquartered in Hong Kong. The conversation focused on conceptions of freedom and their place in Chinese politics prior to the modern period. The content is loosely based on Jiang‘s article “[Isaiah Berlin‘s Challenge to the Zhuangzian Freedom](https://raw.github.com/biyunwu/academic-web/master/src/data/papers/Zhuangzi_and_Berlin_on_freedom_JCP.pdf),” published in *Journal of Chinese Philosophy* in 2012. [Here](https://guoxue.ifeng.com/c/7oXIeFmDwky) is the interview and [here](https://mp.weixin.qq.com/s/elyJ6CIEZBhHxU6Y81Dhbg) is an illustrated version of the interview. Jiang was in Mt. Jiuhua to participate in a forum on Chan Buddhism and Chinese Culture, which has received extensive coverages from [iFeng News](https://guoxue.ifeng.com/c/7oYxlP7MTdw).'
            }
        ],
        pub_1: [
            {
    ...
    about: {
        ...
        name: 'Tao Jiang',
        details: [
            `**Tao JIANG** is a scholar of classical Chinese philosophy, Mahāyāna Buddhist philosophy, and cross-cultural philosophy. He is associate professor in the [Department of Religion](http://religion.rutgers.edu/tao-jiang) and an associate member of the graduate faculty in the Department of Philosophy at Rutgers University, New Brunswick. `,
            `Jiang grew up in the ancient city of [Chengdu](https://www.nytimes.com/2016/03/06/t-magazine/chengdu-china-travel-guide.html) in China’s southwest, “where the pace is slow, the food is spicy and there’s always time for a good gossip over a cup of tea.” As a boy, he often dreamt of an adventurous life in a faraway place, which probably explains why he came all the way to America to pursue his dream. Although America is far enough from China, an academic life devoted to philosophical inquiry does not sound like much of an adventure. Except it *is* an adventure: a genuine philosophical inquiry is an adventure of the mind in which that very inquisitive mind is its own limit. Jiang’s approach to philosophy is to treat it as a way to study particular forms of intellectual and moral culture and the people who produce it.`,
            `Jiang is the author of [*Contexts and Dialogue: Yogācāra Buddhism and Modern Psychology on the Subliminal Mind*](/buddhism_and_psychology) and the co-editor of [*The Reception and Rendition of Freud in China: China’s Freudian Slip*](/freud_in_china). His [articles](/papers) have appeared in leading Asian and comparative philosophy journals and several major anthologies. Currently Tao is working on several book projects simultaneously. A monograph on classical Chinese philosophy is the closest to completion. Others include a new interpretation of Linji's Chan Buddhist philosophy, Buddha Nature in medieval Chinese intellectual history and a comparative project on free will. He has also written about religions in contemporary China. `,
            `Jiang is director of the multidisciplinary [Rutgers Center for Chinese Studies](https://rccs.rutgers.edu). He also co-directs the [Rutgers Workshop on Chinese Philosophy](/events) and co-chairs the Neo-Confucian Studies Seminar at Columbia University. He is currently the co-chair of the Buddhist Philosophy Unit under the American Academy of Religion annual meeting.`,
            `Jiang is married. He and his spouse enjoy hanging out in coffee shops, museums, parks, and watching movies. They play tennis from time to time and love going to the US Open Tennis Championships. They support all effort dedicated to the saving of the world's wildlife. These amazing videos [“Hungry polar bear surprises a seal”] (https://www.youtube.com/watch?v=0mgnf6t9VEc), [“Elephant Calf Starves To Death Due To Drought”] (https://www.youtube.com/watch?v=RqeC6XB94zs) from the [BBC Earth series] (https://www.facebook.com/bbcearth) have opened up their eyes to the beauty, intelligence and misery of animal lives in the wilderness. Check them out, if you haven't, and your view about wildlife will never be the same again.`
        ]
    }
}
