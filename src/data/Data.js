const data = {
    ...
    about: {
        ...
        details: [
            ...
            `Jiang is happily married. He and his spouse enjoy hanging out in coffee shops, museums, parks, and watching movies. They play tennis from time to time. Jiang supports charities that are dedicated to saving the world's wildlife. These amazing videos [“Hungry polar bear surprises a seal”] (https://www.youtube.com/watch?v=0mgnf6t9VEc), [“Elephant Calf Starves To Death Due To Drought”] (https://www.youtube.com/watch?v=RqeC6XB94zs) from the [BBC Earth series] (https://www.facebook.com/bbcearth) have opened his eyes to the beauty, intelligence and misery of animal lives in the wilderness. Check them out, if you haven't, and your view about wildlife will never be the same again.`
        ]
    }
}
