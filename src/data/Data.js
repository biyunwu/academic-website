const data = {
    ...
    about: {
        ...
        details: [
            ...
            `I am the author of [*Contexts and Dialogue: Yogācāra Buddhism and Modern Psychology on the Subliminal Mind*](/buddhism_and_psychology) and the co-editor of [*The Reception and Rendition of Freud in China: China’s Freudian Slip*](/freud_in_china). My [articles](/papers) have appeared in leading Asian and comparative philosophy journals and several major anthologies. Currently I am working on several book projects simultaneously. A monograph on classical Chinese philosophy was just finished. Others include a new interpretation of Linji's Chan/Zen Buddhist philosophy, Buddha Nature in medieval Chinese intellectual history and a comparative project on free will. `,
            `I am Chair of the [Religion Department](https://religion.rutgers.edu) and Director of the [Center for Chinese Studies](https://rccs.rutgers.edu) at Rutgers University, New Brunswick, New Jersey. I also co-direct the [Rutgers Workshop on Chinese Philosophy](/events) and co-chair the [Neo-Confucian Studies Seminar](http://universityseminars.columbia.edu/seminars/neo-confucian-studies/) at Columbia University. I am currently the co-chair of the [Buddhist Philosophy Unit](https://papers.aarweb.org/pu/buddhist-philosophy-unit) under the American Academy of Religion annual meeting.`,
