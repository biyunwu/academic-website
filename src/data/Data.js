const data = {
    ...
    about: {
        ...
        name: 'Tao Jiang',
        details: [
            `Tao JIANG grew up in the ancient city of [Chengdu](https://www.nytimes.com/2016/03/06/t-magazine/chengdu-china-travel-guide.html) in China’s southwest, “where the pace is slow, the food is spicy and there’s always time for a good gossip over a cup of tea.” When he was a boy, Jiang often dreamt of “an adventurous life in a faraway place,” which probably explains why he came all the way to America to pursue his dream. He is a scholar of classical Chinese philosophy, Mahāyāna Buddhist philosophy, and comparative philosophy. He is associate professor in the [Department of Religion](http://religion.rutgers.edu/tao-jiang) and an associate member of the graduate faculty in the Department of Philosophy at Rutgers, the State University of New Jersey in New Brunswick, US. He is director of the multidisciplinary [Rutgers Center for Chinese Studies](https://rccs.rutgers.edu).`,
            `Although America is far enough from China, an academic life devoted to philosophical inquiry does not sound like much of an adventure. Except it *is* an adventure: a genuine philosophical inquiry is an adventure of the mind in which that very inquisitive mind is its own limit. Jiang’s approach to philosophy is to treat it as a way to study a particular form of intellectual, moral and material culture and the people who produce it.`,
            `Jiang is the author of *Contexts and Dialogue: Yogācāra Buddhism and Modern Psychology on the Subliminal Mind* and the co-editor of *The Reception and Rendition of Freud in China: China’s Freudian Slip*. His articles have appeared in leading Asian and comparative philosophy journals and several major anthologies. Currently he is completing a monograph on classical Chinese philosophy. Jiang co-directs the Rutgers Workshop on Chinese Philosophy and co-chairs the Neo-Confucian Studies Seminar at Columbia University. He is currently serving in the program committee of the American Academy of Religion.`,
            `Jiang lives in the NYC metro area. He enjoys hanging out in coffee shops, museums, parks, and watching movies. He plays tennis from time to time and occasionally indulges in watching US Open Tennis Championship in person. He supports charities that are dedicated to saving the world's wildlife. These amazing videos [“Hungry polar bear surprises a seal”] (https://www.youtube.com/watch?v=0mgnf6t9VEc), [“Elephant Calf Starves To Death Due To Drought”] (https://www.youtube.com/watch?v=RqeC6XB94zs) from the [BBC Earth series] (https://www.facebook.com/bbcearth) have opened his eyes to the beauty, intelligence and misery of animal lives in the wilderness. Check them out, if you haven't, and your view about wildlife will never be the same again.`
        ]
    }
}
